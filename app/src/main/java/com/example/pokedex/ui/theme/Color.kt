...
val HPColor = Color(0xFFF9FF58)
val AtkColor = Color(1.0f, 0.635f, 0.635f, 0.659f)
val DefColor = Color(0.569f, 0.663f, 1.0f, 0.439f)
val SpAtkColor = Color(0.867f, 0.592f, 1.0f, 0.569f)
val SpDefColor = Color(0.741f, 1.0f, 0.992f, 0.702f)
val SpdColor = Color(0.659f, 1.0f, 0.682f, 0.549f)
...
val TypeGrass = Color(0xFF4A6647)
val TypeIce = Color(0xFF96D9D6)
val TypeFighting = Color(0xFFC22E28)
val TypePoison = Color(0xFF453EA3)
